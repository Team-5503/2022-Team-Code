 ...
 // Other
  ...
  public RobotContainer() {
    ...
    // Commands
      ...
      m_ejectBallCommand = new EjectBall(m_intake, m_intakeAgitator);
  ...
  private void dashboardInit () {
    ...
    // Teleop
      ...
      SmartDashboard.putBoolean("Disable Left Climber", false);
      SmartDashboard.putBoolean("Disable Right Climber", false);
