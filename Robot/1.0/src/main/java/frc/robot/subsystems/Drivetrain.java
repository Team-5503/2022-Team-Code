...
public class Drivetrain extends SubsystemBase {
  ...
  public void ArcadeDrive (double XSpd, double YSpd) {
    ...
    drive.arcadeDrive(RobotContainer.controller.getRawAxis(0) * XSpd, 
    RobotContainer.controller.getRawAxis(1) * YSpd);
  }
  
  public void LimelightDrive_X (double XSpd, double YSpd) {
    drive.setMaxOutput(0.6);
    drive.arcadeDrive(XSpd, RobotContainer.controller.getRawAxis(1) * YSpd);
  }
