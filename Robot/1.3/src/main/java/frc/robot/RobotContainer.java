...
import frc.robot.commands.ShooterLift.Agitator.AgitatorCommand;
import frc.robot.commands.ShooterLift.LowerLift.IndexerDown;
import frc.robot.commands.ShooterLift.LowerLift.IndexerUp;
 ...
 // Other
  ...
  public RobotContainer() {
    ...
    // Commands
      ...
      m_autoCommand = new Auto(m_drivetrain, m_limelight, m_shooter, m_indexer, m_agitator, m_intakeArms);
